        ...
        return {
            ...
            "function": {
                ...
                "description": (
                    ...
                    "browser for bot-protected hosts. Resolve the exact file URL first "
                    "(release API, search result, or the page's download link); never "
                    "construct one from memory. This tool does not tell you what the "
